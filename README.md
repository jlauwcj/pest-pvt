...
```
./dist_train.sh ./configs/atss_pvt_v2_b2_fpn_3x_mstrain_fp16.py 1
自己训练数据集需要改动mmdet文件，具体：https://blog.csdn.net/qq_39435411/article/details/120756080
 ./dist_train.sh ./configs/atss_swin_l-p4_fpn_dyhead_mstrain2x_voc.py --resume-from work_dirs/atss_swin_l-p4_fpn_dyhead_mstrain2x_voc/latest.pth 1
python train.py ./configs/atss_pvt_v2_b2_fpn_3x_mstrain_fp16.py 1
python train.py ./configs/atss_swin_l-p4_fpn_dyhead_mstrain2x_voc.py 1
python test.py ./configs/atss_pvt_v2_b2_fpn_3x_mstrain_fp16.py ./work_dirs/atss_pvt_v2_b2_fpn_3x_mstrain_fp16/latest.pth --out aaa.pkl --eval mAP
python test.py ./configs/atss_swin_l-p4_fpn_dyhead_mstrain2x_voc.py ./work_dirs/atss_swin_l-p4_fpn_dyhead_mstrain2x_voc/latest.pth --out aaa.pkl --eval mAP
--resume-from work_dirs/yyy/latest.pth

python test.py ./work_dirs/atss_pvtv2_nodyhead_ass/atss_pvtv2_nodyhead_ass.py ./work_dirs/atss_pvtv2_nodyhead_ass/latest.pth --out aaa.pkl --eval mAP
